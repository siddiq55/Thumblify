    ...
    <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-28 lg:pb-8">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className={`space-y-6 ${id && "pointer-events-none"}`}>
          <div className="p-6 rounded-2xl bg-white/8 border border-white/12 shadow-2xl space-y-6">
            <div>
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-lg border border-white/10 bg-white/6 text-zinc-100 placeholder:text-zinc-400 focus:outline-none focus:ring-3 focus:ring-pink-500 resize-none"
                ></textarea>
              </div>
            </div>
